...
namespace AmazTool.Resx {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   查找类似 Failed to terminate the YiLink. Close it manually, or the upgrade may fail. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Start YiLink, please wait... 的本地化字符串。
        /// </summary>
        internal static string RestartYiLink {
            get {
                return ResourceManager.GetString("RestartYiLink", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Try to terminate the YiLink process... 的本地化字符串。
        /// </summary>
