...
public class Global
{
    ...
    public const string AppName = "YiLink";
    ...
    public const string AutoRunName = "YiLinkAutoRun";
    ...
    public const string AvaAssets = "avares://YiLink/Assets/";
    public const string LocalAppData = "YILINK_LOCAL_APPLICATION_DATA_V2";
    ...
    [
        "",
            @"https://cdn.jsdelivr.net/gh/runetfreedom/russia-v2ray-custom-routing-list@main/YiLink/template.json",
            @"https://cdn.jsdelivr.net/gh/Chocolate4U/Iran-v2ray-rules@main/YiLink/template.json"
    ];

    public static readonly List<string> DNSTemplateSources =
    [
        "",
            @"https://cdn.jsdelivr.net/gh/runetfreedom/russia-v2ray-custom-routing-list@main/YiLink/",
            @"https://cdn.jsdelivr.net/gh/Chocolate4U/Iran-v2ray-rules@main/YiLink/"
    ];
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
        {
            ...
            { ECoreType.YiLink, "lingyicute/YiLink-Desktop" },
        };
