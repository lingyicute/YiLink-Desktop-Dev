...
public sealed class CoreInfoHandler
{
    ...
    {
        var urlN = GetCoreUrl(ECoreType.YiLink);
        ...
        [
            new CoreInfo
                {
                    CoreType = ECoreType.YiLink,
                    Url = GetCoreUrl(ECoreType.YiLink),
                    ReleaseApiUrl = urlN.Replace(Global.GithubUrl, Global.GithubApiUrl),
                    DownloadUrlWin64 = urlN + "/download/{0}/YiLink-windows-64.zip",
                    DownloadUrlWinArm64 = urlN + "/download/{0}/YiLink-windows-arm64.zip",
                    DownloadUrlLinux64 = urlN + "/download/{0}/YiLink-linux-64.zip",
                    DownloadUrlLinuxArm64 = urlN + "/download/{0}/YiLink-linux-arm64.zip",
                    DownloadUrlOSX64 = urlN + "/download/{0}/YiLink-macos-64.zip",
                    DownloadUrlOSXArm64 = urlN + "/download/{0}/YiLink-macos-arm64.zip",
                },
